...
function ImageBand (){
    return(
        <div className="Images">
            <img className="Image" src="https://zupimages.net/up/19/44/vtng.jpg" alt="pizza&cocktail"></img>
            <img className="Image" src="https://zupimages.net/up/19/44/eqco.jpg" alt="pizza&cocktail"></img>
            <img className="Image" src="https://zupimages.net/up/19/45/biky.jpg" alt="pizza&cocktail"></img>
