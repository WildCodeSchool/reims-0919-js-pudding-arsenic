  ...
  return (
    <div className="PresOfFood">
      ...
      <div className="orga">
        <div className="align">
          <p>
            Tu as changé d'avis, ok'', pour retourner sur la page de filtre,
          ...
          >
            <figure>
              <img
                className="goBack"
                src="https://zupimages.net/up/19/46/hprl.jpg"
                alt="Flèche"
              ></img>
            </figure>
          </button>
        ...
        <div className="align">
          <p>
            Ca ne te plait pas notre recette, tu veux relancer la roulette,
          ...
          <button className="buttonRefresh" type="button" onClick={refreshpage}>
            <figure>
              <img
                className="goRefresh"
                src="https://zupimages.net/up/19/46/swth.jpg"
                alt="Retour"
              ></img>
            </figure>
          </button>
